...
if ($opcion === 'todos') {
    $consulta = "SELECT Prestamos.id_libro, Libros.nombre AS nombre_libro, Usuarios.usuario AS nombre_bibliotecario, 
                 Alumnos.nombre AS nombre_alumno, Alumnos.apellido1, Alumnos.apellido2, Alumnos.curso, Alumnos.numCarnet, 
                 Prestamos.CodPrestamo, Prestamos.fecha_prestamo, Prestamos.fecha_devolucion
                 FROM Prestamos
...
$nombreArchivoPDF = 'listado_morosos_' . $nombreUsuario . '_' . $fechaActual . '_' . $numeroSecuencial . '.pdf';
