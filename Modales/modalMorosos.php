    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button class="btn btn-primary" onclick="generarPDF('todos')">Listado Completo</button>
                <button class="btn btn-warning" onclick="generarPDF('usuario')">Listado Propio</button>
            </div>
    ...
    function generarPDF(opcion) {
        ...
        $.ajax({
            ...
            success: function(data) {
                // Muestra un mensaje de éxito al usuario con SweetAlert
                 Swal.fire({
                    icon: 'success',
                    title: '¡Éxito!',
